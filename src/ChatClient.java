 ...
 * ChatClient - Run instance of a chat client
 */
 ...
 * /Exit -- exit client
 * /private message_receiver_name the_message_goes_here --- sends private message to a specified user
 */ 
...
public class ChatClient {
  ...
  public ChatClient() {
    ...
    // Add Listeners to text field, send texts to server
  ...
  private void verify_name(String line) throws IOException{
    while(line.startsWith("Verified_Name")) {
      getUserInfo();
  ...
  private void run() throws IOException {
    ...
    try{
      ...
      //Server sents back verification, must happen or program exit 
      verify_name(line);
